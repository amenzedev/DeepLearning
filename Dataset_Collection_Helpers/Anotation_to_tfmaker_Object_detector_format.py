...
testing_set = [29,36,39,52,54,70,82,85,90,92] #10% testing from 100 image dataset
...
for file in arr:
    ...
    if "reformat_barrel.py" in file or ".jpg" in file or ".png" in file or ".txt" in file or ".jpeg" in file:
        #print(file)
        arr.remove(file)
    elif ".json" in file:
        #print(file)
